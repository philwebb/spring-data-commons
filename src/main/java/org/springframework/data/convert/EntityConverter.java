...
/**
 * Combined {@link EntityReader} and {@link EntityWriter} and add the ability to access a
 * {@link MappingContext} and {@link ConversionService}.
 *
 * @param <E> the concrete {@link PersistentEntity} implementation the converter is based
 * on.
 * @param <P> the concrete {@link PersistentProperty} implementation the converter is
 * based on.
