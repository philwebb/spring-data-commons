...
public interface MethodsMetadata extends ClassMetadata {
	...
	/**
	 * Return all methods.
	 * @return the methods declared in the class ordered as found in the class file. Order
	 ...
	 * @return the methods matching method {@code name } declared in the class ordered as
	 * found in the class file. Order does not necessarily reflect the declaration order
	 * in the source file.
	 */
