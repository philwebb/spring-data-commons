...
public interface ProjectionInformation {
	 ...
	 * {@link #getInputProperties()} is sufficient to create a working proxy instance.
	 * This will usually be used to determine whether the projection uses any dynamically
	 * resolved properties.
	 * @return
	 */
	boolean isClosed();
