...
/**
 * SPI to create {@link MethodInterceptor} instances based on the given source object and
 * the target type to produce. To be registered with a {@link ProxyProjectionFactory} to
...
public interface MethodInterceptorFactory {
	...
	/**
	 * Returns the {@link MethodInterceptor} to be used for the given source object and
	 * target type.
	 ...
	 * {@link MethodInterceptor} for proxy of the given target type.
	 * @param source will never be {@literal null}.
	 * @param targetType will never be {@literal null}.
	 * @return
	 */
