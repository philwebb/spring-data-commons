...
public interface RepositoryConfiguration<T extends RepositoryConfigurationSource> {
	...
	/**
	 * Returns the {@link RepositoryConfigurationSource} that backs the
	...
	/**
	 * Returns the {@link TypeFilter}s to be used to exclude packages from repository
	 * scanning.
	 * @return
	 */
	...
	/**
	 * Returns the {@link ImplementationDetectionConfiguration} to be used for this
	 * repository.
	...
	/**
	 * Returns the {@link ImplementationLookupConfiguration} for the given
	...
	/**
	 * Returns a human readable description of the repository interface declaration for
