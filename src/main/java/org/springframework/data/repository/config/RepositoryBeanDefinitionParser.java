 ...
 * XML element potentially having child elements. The parser will wrap the XML element
 * into a {@link GlobalRepositoryConfigInformation} object and allow either manual
 * configuration or automatic detection of repository interfaces.
 *
...
public class RepositoryBeanDefinitionParser implements BeanDefinitionParser {
	...
	/**
	 * Creates a new {@link RepositoryBeanDefinitionParser} using the given
	 ...
	 * the given type assuming the bean name has been autogenerated.
	 * @param type
	 * @param registry
	 * @return
	 */
