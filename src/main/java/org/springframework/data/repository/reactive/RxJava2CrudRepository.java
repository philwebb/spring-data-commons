 ...
 * repository follows reactive paradigms and uses RxJava 2 types.
 *
 * @author Mark Paluch
 * @since 2.0
 * @see Maybe
...
public interface RxJava2CrudRepository<T, ID> extends Repository<T, ID> {
	 ...
	 * @return {@link Flowable} emitting the saved entities.
	 * @throws IllegalArgumentException in case the given {@link Flowable entityStream} is
	 * {@literal null}.
	 */
	 ...
	 * @return {@link Maybe} emitting the entity with the given id or
	 * {@link Maybe#empty()} if none found.
	 ...
	 * @return {@link Maybe} emitting the entity with the given id or
	 * {@link Maybe#empty()} if none found.
	 * @throws IllegalArgumentException in case the given {@link Single id} is
	 * {@literal null}.
	 */
	 ...
	 * @param id must not be {@literal null}.
	 * @return {@link Single} emitting {@literal true} if an entity with the given id
	 ...
	 * @return {@link Flowable} emitting the found entities. The size can be equal or less
	 ...
	 * @throws IllegalArgumentException in case the given {@link Flowable idStream} is
	 * {@literal null}.
	 */
