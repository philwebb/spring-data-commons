...
/**
 * Interface for generic CRUD operations on a repository for a specific type. This
 * repository follows reactive paradigms and uses Project Reactor types which are built on
 * top of Reactive Streams.
 *
 * @author Mark Paluch
...
public interface ReactiveCrudRepository<T, ID> extends Repository<T, ID> {
	 ...
	 * @return {@link Flux} emitting the saved entities.
	 * @throws IllegalArgumentException in case the given {@link Publisher entityStream}
	 * is {@literal null}.
	 */
	 ...
	 * @return {@link Mono} emitting the entity with the given id or {@link Mono#empty()}
	 * if none found.
	 ...
	 * @param id must not be {@literal null}. Uses the first emitted element to perform
	 * the find-query.
	 * @return {@link Mono} emitting the entity with the given id or {@link Mono#empty()}
	 * if none found.
	 * @throws IllegalArgumentException in case the given {@link Publisher id} is
	 * {@literal null}.
	 */
	 ...
	 * @param id must not be {@literal null}.
	 * @return {@link Mono} emitting {@literal true} if an entity with the given id
	 * exists, {@literal false} otherwise.
	 * @throws IllegalArgumentException in case the given {@literal id} is
	 * {@literal null}.
	 */
	...
	/**
	 * Returns whether an entity with the given id, supplied by a {@link Publisher},
	 * exists. Uses the first emitted element to perform the exists-query.
	 * @param id must not be {@literal null}.
	 * @return {@link Mono} emitting {@literal true} if an entity with the given id
	 * exists, {@literal false} otherwise.
	 * @throws IllegalArgumentException in case the given {@link Publisher id} is
	 ...
	 * @return {@link Flux} emitting the found entities. The size can be equal or less
	...
	/**
	 * Returns all instances of the type {@code T} with the given IDs supplied by a
	 * {@link Publisher}.
	 * <p>
	 * If some or all ids are not found, no entities are returned for these IDs.
	 * <p>
	 ...
	 * @throws IllegalArgumentException in case the given {@link Publisher idStream} is
	 * {@literal null}.
	 */
