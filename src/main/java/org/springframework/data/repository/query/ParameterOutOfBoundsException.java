...
/**
 * Exception to be thrown when trying to access a {@link Parameter} with an invalid index
 * inside a {@link Parameters} instance.
 *
...
public class ParameterOutOfBoundsException extends RuntimeException {
	...
	/**
	 * Creates a new {@link ParameterOutOfBoundsException} with the given exception as
	 * cause.
	 * @param message
	 * @param cause
	 */
