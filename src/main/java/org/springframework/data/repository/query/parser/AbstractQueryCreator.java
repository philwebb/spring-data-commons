...
public abstract class AbstractQueryCreator<T, S> {
	...
	/**
	 * Creates a new {@link AbstractQueryCreator} for the given {@link PartTree}. This
	 * will cause {@literal null} be handed for the {@link Iterator} in the callback
	 * methods.
	...
	/**
	 * Creates a new {@link AbstractQueryCreator} for the given {@link PartTree} and
	 * {@link ParametersParameterAccessor}. The latter is used to hand actual parameter
	 * values into the callback methods as well as to apply dynamic sorting via a
	 * {@link Sort} parameter.
	 * @param tree must not be {@literal null}.
	...
	/**
	 * Creates the actual query object applying the given {@link Sort} parameter. Use this
	 * method in case you haven't provided a {@link ParameterAccessor} in the first place
	 * but want to apply dynamic sorting nevertheless.
	...
	/**
	 * Actual query building logic. Traverses the {@link PartTree} and invokes callback
	 * methods to delegate actual criteria creation and concatenation.
	 * @param tree must not be {@literal null}.
	 * @return
	 */
	@Nullable
	...
	/**
	 * Creates a new criteria object from the given part and and-concatenates it to the
	 * given base criteria.
	 * @param part must not be {@literal null}.
