 ...
 * Allows to obtain a {@link Pageable} to request a previous or next {@link Slice}.
 *
...
public interface Slice<T> extends Streamable<T> {
	...
	/**
	 * Returns a new {@link Slice} with the content of the current one mapped by the given
	 * {@link Converter}.
	 * @param converter must not be {@literal null}.
	 * @return a new {@link Slice} with the content of the current one mapped by the given
	 * {@link Converter}.
	 * @since 1.10
	 */
