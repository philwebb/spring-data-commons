...
public interface Pageable {
	...
	/**
	 * Returns whether the current {@link Pageable} does not contain pagination
	 * information.
	 * @return
	 */
	...
	/**
	 * Returns the previous {@link Pageable} or the first {@link Pageable} if the current
	...
	/**
	 * Returns whether there's a previous {@link Pageable} we can access from the current
	 * one. Will return {@literal false} in case the current {@link Pageable} already
