...
public interface QuerydslPredicateExecutor<T> {
	...
	/**
	 * Returns all entities matching the given {@link Predicate}. In case no match could
	...
	/**
	 * Returns all entities matching the given {@link Predicate} applying the given
	 * {@link OrderSpecifier}s. In case no match could be found an empty {@link Iterable}
	 * is returned.
	 * @param predicate must not be {@literal null}.
	 * @param orders the {@link OrderSpecifier}s to sort the results by, must not be
	 * {@literal null}.
	 * @return all entities matching the given {@link Predicate} applying the given
	...
	/**
	 * Returns a {@link Page} of entities matching the given {@link Predicate}. In case no
