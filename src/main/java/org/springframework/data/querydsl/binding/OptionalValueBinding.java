...
/**
 * {@link OptionalValueBinding} creates a {@link Predicate} out of given {@link Path} and
 * value. Used for specific parameter treatment in {@link QuerydslBindings}.
 *
...
public interface OptionalValueBinding<T extends Path<? extends S>, S> {
	 ...
	 * The given value will be the first the first one provided for the given path and
