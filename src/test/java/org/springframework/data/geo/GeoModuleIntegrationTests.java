...
class GeoModuleIntegrationTests {
	...
	void deserializesDistance() throws Exception {
		...
		assertThat(this.mapper.readValue(json, Distance.class)).isEqualTo(reference);
	...
	void deserializesPoint() throws Exception {
		...
		assertThat(this.mapper.readValue(json, Point.class)).isEqualTo(reference);
		assertThat(this.mapper.writeValueAsString(reference)).isEqualTo(json);
	}
	...
	void deserializesCircle() throws Exception {
		...
		assertThat(this.mapper.readValue(json, Circle.class)).isEqualTo(reference);
		assertThat(this.mapper.writeValueAsString(reference)).isEqualTo(json);
	}
	...
	void deserializesBox() throws Exception {
		...
		assertThat(this.mapper.readValue(json, Box.class)).isEqualTo(reference);
		assertThat(this.mapper.writeValueAsString(reference)).isEqualTo(json);
	}
